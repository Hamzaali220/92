...
class SurveyController extends Controller
{
    ...
    {
        $import = new Survey;
        $result = $import->getDetailsByAny($limit, array(
            'agents_survey.survey' => '1', 'agents_survey.is_deleted' => '0', 'agents_survey.agents_user_id' => $agents_user_id, 'agents_survey.agents_users_role_id' => $agents_users_role_id
        ));
        echo '<pre.';
        print_r($result);
        exit;
