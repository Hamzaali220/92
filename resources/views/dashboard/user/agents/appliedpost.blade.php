				...
				<div class="box-shadow-profile ">
					<div class="panel-profile">
						<div class="panel-heading overflow-h air-card">
							<label style="margin: 0;" class="radio-inline">
						...
						<div>	
							...
							<div id="loadappliedpost" class="col-md-12 center loder loadappliedpost"><img src="{{ url('/assets/img/loder/loading.gif') }}" width="64px" height="64px" id="post_loader_img"/></div>
...
<script type="text/javascript">
	...
	function loadappliedpost(limit) {
		...
		$.ajax({
			url: "{{url('/applied/post/list/get/')}}/"+limit+"/{{ $user->id }}/{{ $user->agents_users_role_id }}/2/"+user_type,
			type: 'get',
					...
					$.each( postdata.result, function( key, value ) {
						...
						var htmll = '<div class="border1-bottom" id="post_list_data_'+value.post_id+'">'+
										...
										htmll +='<ul class="list-inline">'+
													...
													'<li><span>'+value.post_view_count+' Agents Applied </span> </li>'+
													...
													'<li><span> Closing Date : '+close_date+' </span> </li>'+
												'</ul>'+
										'</div>'+
