...
@section('content')
  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Seller/Buyer
        <small> Seller/Buyer list</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"> Seller/Buyer</a></li>
        <li class="active"> Seller/Buyer list</li>
      </ol>
    </section>
		              	...
		              	<?php $i=1; foreach($catlist as $cat){ ?>
		              			<tr>
		              				...
		              				<td>
		              					...
		              					<button type="button" class="btn btn-danger" id="{{ $cat->id }}" onclick="deletecat(this.id)">Delete</button>
		              				</td>
		              			</tr>
		              		<?php $i++;} ?>
		              	</tbody>
